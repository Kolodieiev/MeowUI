...
namespace meow
{
    ...
    public:
         ...
         *      Задає стартову ширину віджета таким чином, щоб вмістити текст + відступ.
         * @param  add_width_value
         *      Значення буде додане до ширини елементу. По замовченню 0.
         */
        void initWidth(uint16_t add_width_value = 0);

        /*!
         * @brief
         *      Викликайте цей метод тільки після того, як налаштували інші параметри для віджета.
         *      Вираховує і підганяє ширину віджета таким чином, щоб вмістити текст + відступ.
         *      Може бути використаний в процесі роботи дисплею, якщо віджет має фоновий колір, який потрібно перемальовувати разом з текстом.
         * @param  add_width_value
         *      Значення буде додане до ширини елементу. По замовченню 0.
         */
