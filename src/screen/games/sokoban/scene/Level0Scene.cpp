...
void Level0Scene::createSokoban()
{
    ...
    _sokoban->_x_global = 32;       // Встановити глобальні координати об'єкта 2 плитки зліва. Точка відліку починається у верхньому лівому куті як для мапи так і для об'єктів.
    _sokoban->_y_global = 2 * 32;   // Встановити глобальні координати об'єкта 2 плитки зверху.
}
